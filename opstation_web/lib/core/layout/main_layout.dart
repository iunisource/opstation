  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final posItems = <Widget>[
      if (modules.contains('pos')) ...[
        _menuItem(context, 'Configuration', Icons.tune_outlined, '/erp/pos-config', location),
    ...
    final financialItems = <Widget>[
      ...
      _menuItem(context, 'Account Activity', Icons.receipt_long_outlined, '/financials/account-activity', location),
