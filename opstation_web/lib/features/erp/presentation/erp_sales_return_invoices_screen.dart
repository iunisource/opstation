...
class _SriAuditTrail extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<dynamic>>(
      future: Supabase.instance.client.from('voucher_audit_log').select('action,details,user_id,created_at').eq('voucher_id', voucherId).eq('voucher_type', 'SRI').order('created_at', ascending: false).limit(20),
      builder: (ctx, snap) {
