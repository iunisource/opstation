...
const List<_GuideSection> _kGuide = [
  ...
  _GuideSection(
    ...
    [
      _GuideItem('Products', 'The master list of everything you buy, make or sell, each with its unit, classification, prices and the branches that carry it. Items flagged as non-inventory (service or labour) appear here too but are never stocked or costed.'),
  ...
  _GuideSection(
    ...
    [
      ...
      _GuideItem('Production Inverse Voucher', 'Reverse a production run - break a finished item back down into its components.'),
      ...
      _GuideItem('Finished Goods without BOM', 'A watchlist of manufactured items that have no recipe defined yet - fix these so their production and costing work correctly.'),
  ...
  _GuideSection(
    ...
    [
      ...
      _GuideItem('Admin Settings', 'Organisation-level settings, defaults and toggles.'),
